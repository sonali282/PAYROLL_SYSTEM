...
public class project extends JFrame implements ActionListener {
    ...
    project()
    {
        ...
        t1.setMnemonic('N');
        t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icons/New.png")));
        ...
        t3.setFont(new Font("monospaced",Font.PLAIN,14));
        t3.setMnemonic('S');
        ...
        t4.setFont(new Font("monospaced",Font.PLAIN,14));
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icon/newinvoice.png")));
        ...
        s1.setFont(new Font("monospaced",Font.PLAIN,14));
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icons/EditOpen.png")));
        ...
        s2.setFont(new Font("monospaced",Font.PLAIN,14));
        s2.setMnemonic('P');
        ...
        s3.setFont(new Font("monospaced",Font.PLAIN,14));
        s3.setMnemonic('T');
        ...
        JMenuItem p1 = new JMenuItem("Generate Pay Slip");
        p1.setForeground(Color.blue);
        p1.setFont(new Font("monospaced",Font.PLAIN,14));
        p1.setMnemonic('Q');
        p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icon/payments.png")));
        p1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,ActionEvent.CTRL_MASK));
        ...
        p2.setFont(new Font("monospaced",Font.PLAIN,14));
        p2.setMnemonic('R');
        p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icon/empreport.png")));
        p2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,ActionEvent.CTRL_MASK));
        ...
        u1.setMnemonic('O');
        u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("payroll_system/icons/New.png")));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(msg.equals("Generate Pay Slip"))
        {
